...
% ----------------------------------------------
%                    敏求 Miin Wu School of Computing
% ----------------------------------------------

% 系 Department of Intelligent Technology Systems
\newcommand{\SetDeptITS}
{
  \SetDeptName{智慧科技系統碩士學位學程}{ITS}{MS Degree Program on Intelligent Technology Systems}
  % \SetCollegeMiinWuSchoolofComputing
  \SetCollegeEngineering
} % End of \newcommand{}

% 系 Department of AI Robotics
\newcommand{\SetDeptAIR}
{
  \SetDeptName{人工智慧機器人碩士學位學程}{AIR}{MS Degree Program on AI Robotics}
  % \SetCollegeMiinWuSchoolofComputing
  \SetCollegeEngineering
} % End of \newcommand{}
